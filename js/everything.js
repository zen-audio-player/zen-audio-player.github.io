...
/**
 * This function initializes the authentication using YouTube API 
 */
function initAuth() {
	...
	gapi.auth2.init({
		...
		$("#youtube-login").click(handleAuthClick);
	});
}
/**
 * When the app sign in status changes this function gets called
 * @param {boolean} isSignedIn is the sign in succeeded 
 */
...
/**
 * This function contains the requests that will be executed after the load completed
 */
...
/**
 * This function hides th login button from the page
 */

 ...
 * If the localStorage doesn't contain zap_playlist_id: the call will be to create the playlist in the user YouTube account and then store the zap_playlist_id
 */
...
function showSignInButton() {
	$(document).ready(function () {
		$('#demo').removeClass('expanded');
		$('#youtube-login').show();
		$('#youtube-login').addClass('visible');
	});
}
